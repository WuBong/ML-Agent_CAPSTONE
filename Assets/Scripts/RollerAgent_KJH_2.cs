...
public class RollerAgent_KJH_2 : Agent
{
    ...
    public override void OnEpisodeBegin()
    {
        ...
        this.transform.localPosition = StartPoint.localPosition;
    ...
    private void SpawnObject()
    {
        ...
        GameObject Start_A = GameObject.FindGameObjectWithTag("Start_A");
        GameObject Start_B = GameObject.FindGameObjectWithTag("Start_B");
        ...
        for (int i = 0; i < maxTries && !validPosition; i++)
        {
            ...
            Bounds goalBounds = new Bounds(testPos, new Vector3(7f, 7f, 7f)); // Goal의 바운딩 박스
